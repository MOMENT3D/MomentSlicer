...
![Screenshot 2023-09-18 at 22 44 26](https://github.com/SoftFever/MomentSlicer/assets/59056762/281b9c78-9f5c-428e-86b9-509de099a3e7)
...
![ERS Disabled](https://github.com/SoftFever/MomentSlicer/assets/59056762/31fdbf91-2067-4286-8bc1-4f7de4a628b6)
...
A printer's motion system does not exactly follow the speed changes seen in the gcode preview screen of Moment Slicer. 
...
![image](https://github.com/igiannakas/MomentSlicer/assets/59056762/4ba0356b-49ab-428c-ab10-f2c88bcc1bcb)

![image](https://github.com/igiannakas/MomentSlicer/assets/59056762/3958deb5-fbc3-4d07-8903-4575033717fd)

The time taken to decelerate to this new speed would be approx. 0.08 seconds, derived from the following equation:

![image](https://github.com/igiannakas/MomentSlicer/assets/59056762/ea9f19b4-defe-4656-9ecc-a6576c87d8e0)
...
![image](https://github.com/igiannakas/MomentSlicer/assets/59056762/83242b26-7174-4da1-b815-d9fcec767bcd)
...
Ideally you want this value set to 1 to allow for the largest number of steps between each speed transition. However, this may result in a too large of a gcode, with too many commands sent to your MCU per second and it may not be able to keep up. It will also slow down the Moment Slicer front end as the sliced model is more complex to render.
