var LangText = {
  ...
  es_ES: {
    ...
    t2: "Va a configurar Moment Slicer mediante varios pasos. ¡Vamos a comenzar!",
    ...
    t52: "Saltar",
    t53: "Ingresar",
    t54: "En la comunidad de impresión 3D, pordemos aprender de los logros y los fallos de otros para obtener nuestros propios parametros y configuraciones de Moment Slicer follows the same principle and uses machine learning to improve its performance from the successes and failures of the vast number of prints by our users. We are training Moment Slicer to be smarter by feeding them the real-world data. If you are willing, this service will access information from your error logs and usage logs, which may include information described in ",
    ...
    t83: "2, Cerrar todos los Moment Slicer abiertos",
    t84: "3, Borrar todos los archivos en el directorio de complementos",
    t85: "4, Reabrir Moment Slicer e instalar el complemento de nuevo",
    t86: "Cerrar",
  ...
  ru_RU: {
    ...
    t2: "Для настройка Moment Slicer необходимо пройти несколько этапов. Давайте начнём!",
    ...
    t52: "Пропустить",
    t53: "Войти",
    t54: "В сообществе 3D-печатников для выявления наилучших параметров нарезки и улучшения печати мы учимся на успехах и неудачах друг друга. Moment Slicer следует тому же принципу и использует машинное обучение для улучшения своей работы на основе успешных и неудачных печатей наших пользователей. Мы обучаем Moment Slicer быть умнее на основе реальных данных. По вашему согласию эта служба получит доступ к вашим журналам ошибок и журналам использования, в которых содержатся сведения, описанные в ",
    ...
    t83: "2, Закрыть все открытые Moment Slicer",
    t84: "3, Удалить все файлы в папке плагина",
    t85: "4, Откройте Moment Slicer и снова установите подключаемый модуль.",
    t86: "Закрыть",
    t87: "Инструкции",
    t88: "Удалить",
  ...
  pt_BR: {
    ...
    t2: "Moment Slicer será configurado em algumas etapas. Vamos começar!",
    t3: "Termos de Uso",
    t4: "Discordo",
    t5: "Concordo",
