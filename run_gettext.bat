...
if %FULL_MODE%==1 (
    .\tools\xgettext.exe --keyword=L --keyword=_L --keyword=_u8L --keyword=L_CONTEXT:1,2c --keyword=_L_PLURAL:1,2 --add-comments=TRN --from-code=UTF-8 --no-location --debug --boost -f ./localization/i18n/list.txt -o ./localization/i18n/MomentSlicer.pot
...
:processFile
    ...
    .\tools\msgfmt.exe --check-format -o "./resources/i18n/%lang%/MomentSlicer.mo" "%file%"
goto :eof
