...
# Set this so that Moment Slicer doesn't complain about
# the CA cert path on every startup
ENV SSL_CERT_FILE=/etc/ssl/certs/ca-certificates.crt

COPY ./ MomentSlicer

WORKDIR MomentSlicer
...
# It's easier to run Moment Slicer as the same username,
...
ENTRYPOINT ["/MomentSlicer/build/package/bin/Moment-slicer"]
