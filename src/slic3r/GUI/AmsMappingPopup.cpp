...
//
//    if (m_selected) {
//        dc.SetPen(AMS_CONTROL_BRAND_COLOUR); // MOMENT Highlight color for selected AMS in send job dialog
//        dc.SetBrush(*wxTRANSPARENT_BRUSH);
//        dc.DrawRoundedRectangle(FromDIP(1), FromDIP(1), MATERIAL_ITEM_SIZE.x - FromDIP(1), MATERIAL_ITEM_SIZE.y - FromDIP(1), 5);
//    }
//#else
...
void AmsReplaceMaterialDialog::create()
{
    ...
    identical_filament->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#960000")));
