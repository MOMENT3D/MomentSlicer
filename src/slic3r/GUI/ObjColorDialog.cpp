...
const  StateColor ok_btn_bg(std::pair<wxColour, int>(wxColour(103, 0, 0), StateColor::Pressed),
...
{
    std::string icon_path = (boost::format("%1%/images/MomentSlicerTitle.ico") % Slic3r::resources_dir()).str();
...
{
    auto       btn_sizer = new wxBoxSizer(wxHORIZONTAL);
    StateColor calc_btn_bg(std::pair<wxColour, int>(wxColour(103, 0, 0), StateColor::Pressed), std::pair<wxColour, int>(wxColour(182, 76, 76), StateColor::Hovered),
                           std::pair<wxColour, int>(wxColour(150, 0, 0), StateColor::Normal));
    StateColor calc_btn_bd(std::pair<wxColour, int>(wxColour(150, 0, 0), StateColor::Normal));
