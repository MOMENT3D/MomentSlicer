...
#define PRINTER_SPACE_SIZE wxSize(FromDIP(100), FromDIP(24)) // MOMENT Match size with other components
...
#define SELECT_ALL_OPTION_COLOUR wxColour("#960000")
...
wxBoxSizer *CreatePrinterPresetDialog::create_bed_size_item(wxWindow *parent)
{
    ...
    wxBoxSizer *  length_sizer          = new wxBoxSizer(wxVERTICAL);
     // MOMENT use icon on input box to match style with other Point fields
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(150, 0, 0), StateColor::Pressed), std::pair<wxColour, int>(wxColour(150, 0, 0), StateColor::Hovered),
