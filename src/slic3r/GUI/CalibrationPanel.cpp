...
void CalibrationPanel::init_tabpanel() {
    ...
    m_tabpanel->SetBackgroundColour(wxColour("#FEFFFF")); // MOMENT match sidebar background color
    ...
    // MOMENT use standard paddings and keep arrow icon for consistent look between sidebars
    //for (int i = 0; i < (int)CALI_MODE_COUNT; i++)
