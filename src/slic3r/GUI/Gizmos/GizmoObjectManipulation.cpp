 ...
 bool GizmoObjectManipulation::bbl_checkbox(const wxString &label, bool &value)
{
     ...
     bool b_value = value;
     if (b_value) {
         ImGui::PushStyleColor(ImGuiCol_FrameBg, ImVec4(0.68f, 0.00f, 0.00f, 1.00f));
         ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, ImVec4(0.68f, 0.00f, 0.00f, 1.00f));
         ImGui::PushStyleColor(ImGuiCol_FrameBgActive, ImVec4(0.68f, 0.00f, 0.00f, 1.00f));
     }
