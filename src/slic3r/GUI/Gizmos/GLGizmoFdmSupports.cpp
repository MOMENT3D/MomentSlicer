...
void GLGizmoFdmSupports::on_render_input_window(float x, float y, float bottom_limit)
{
    ...
    for (int i = 0; i < tool_ids.size(); i++) {
        ...
        if (m_current_tool == tool_ids[i]) {
            ImGui::PushStyleColor(ImGuiCol_Button, m_is_dark_mode ? ImVec4(50 / 255.0f, 39 / 255.0f, 39 / 255.0f, 1.00f) : ImVec4(0.98f, 0.93f, 0.93f, 1.00f)); // r, g, b, a
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, m_is_dark_mode ? ImVec4(50 / 255.0f, 39 / 255.0f, 39 / 255.0f, 1.00f) : ImVec4(0.98f, 0.93f, 0.93f, 1.00f));
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, m_is_dark_mode ? ImVec4(50 / 255.0f, 39 / 255.0f, 39 / 255.0f, 1.00f) : ImVec4(0.98f, 0.93f, 0.93f, 1.00f));
