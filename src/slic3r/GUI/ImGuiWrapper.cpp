...
static const std::map<const wchar_t, std::string> font_icons = {
    ...
    {ImGui::gCodeButtonIcon        , "im_code"                       }, //MOMENT
    {ImGui::VisibleIcon            , "im_visible"                    }, //MOMENT
    {ImGui::HiddenIcon             , "im_hidden"                     }, //MOMENT
    ...
    //{ImGui::HorizontalHide        , "horizontal_hide"               }, // MOMENT use ExpandBtn / CollapseBtn
...
const ImVec4 ImGuiWrapper::COL_RED_LIGHT       = { 255 / 255.f, 102 / 255.f, 102 / 255.f, 0.25f }; // MOMENT used on various places like text selection bg. Replaced with orca color
...
const ImVec4 ImGuiWrapper::COL_TOOLBAR_BG        = { 250 / 255.f, 250 / 255.f, 250 / 255.f, 1.f }; // MOMENT color matches with toolbar_background.png
const ImVec4 ImGuiWrapper::COL_TOOLBAR_BG_DARK   = { 57  / 255.f, 60  / 255.f, 66  / 255.f, 1.f }; // MOMENT color matches with toolbar_background_dark.png
const ImVec4 ImGuiWrapper::COL_MOMENT              = to_ImVec4(ColorRGBA::MOMENT());
const ImVec4 ImGuiWrapper::COL_MODIFIED          = { 253.f / 255.f, 111.f / 255.f, 40.f / 255.f, 1}; // MOMENT same color with m_color_label_modified
...
bool ImGuiWrapper::bbl_checkbox(const wxString &label, bool &value)
{
    ...
    bool b_value = value;
    if (b_value) {
        ImGui::PushStyleColor(ImGuiCol_FrameBg, ImVec4(0.59f, 0.00f, 0.00f, 1.00f));
        ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, ImVec4(0.59f, 0.00f, 0.00f, 1.00f));
        ImGui::PushStyleColor(ImGuiCol_FrameBgActive, ImVec4(0.59f, 0.00f, 0.00f, 1.00f));
    }
    auto label_utf8 = into_u8(label);
...
bool ImGuiWrapper::slider_float(const char* label, float* v, float v_min, float v_max, const char* format/* = "%.3f"*/, float power/* = 1.0f*/, bool clamp /*= true*/, const wxString& tooltip /*= ""*/, bool show_edit_btn /*= true*/)
{
    ...
    if (show_edit_btn) {
        ImGui::PushStyleVar(ImGuiStyleVar_ItemSpacing, { 1, style.ItemSpacing.y });
        ImGui::PushStyleVar(ImGuiStyleVar_FrameBorderSize, 0);        // MOMENT match edit button style
        ImGui::SameLine();
        std::wstring btn_name = ImGui::SliderFloatEditBtnIcon + boost::nowide::widen(str_label);
        ImGui::PushStyleColor(ImGuiCol_Button, { 0.25f, 0.25f, 0.25f, 0.0f });
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, {0, 0, 0, 0 }); // MOMENT match edit button style
        ImGui::PushStyleColor(ImGuiCol_ButtonActive,  {0, 0, 0, 0 }); // MOMENT match edit button style
...
void ImGuiWrapper::push_toolbar_style(const float scale)
{
    if (m_is_dark_mode) {
        ...
        ImGui::PushStyleColor(ImGuiCol_TextSelectedBg, ImVec4(50 / 255.0f, 39 / 255.0f, 39 / 255.0f, 1.00f));         // 12
        ...
        ImGui::PushStyleColor(ImGuiCol_FrameBg, ImVec4(238 / 255.0f, 238 / 255.0f, 238 / 255.0f, 0.00f));        // 11
        ImGui::PushStyleColor(ImGuiCol_TextSelectedBg, COL_RED_LIGHT);                                     // 12
        ImGui::PushStyleColor(ImGuiCol_CheckMark, ImVec4(1.00f, 1.00f, 1.00f, 1.00f));//13
...
void ImGuiWrapper::push_common_window_style(const float scale) {
    if (m_is_dark_mode) {
        ...
        ImGui::PushStyleColor(ImGuiCol_Separator, ImGuiWrapper::COL_SEPARATOR_DARK);                             // 5
        ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(1.00f, 1.00f, 1.00f, 1.00f));                              // 6
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImVec4(0.59f, 0.00f, 0.00f, 1.00f));                       // 7
        ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4(0.59f, 0.00f, 0.00f, 1.00f));                        // 8
        ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, ImVec4(84 / 255.0f, 84 / 255.0f, 90 / 255.0f, 1.00f));    // 9
        ImGui::PushStyleColor(ImGuiCol_FrameBgActive, ImVec4(62 / 255.0f, 62 / 255.0f, 69 / 255.0f, 1.00f));     // 10
        ImGui::PushStyleColor(ImGuiCol_FrameBg, ImVec4(238 / 255.0f, 238 / 255.0f, 238 / 255.0f, 0.00f));        // 11
        ImGui::PushStyleColor(ImGuiCol_CheckMark, ImVec4(1.00f, 1.00f, 1.00f, 1.00f));                           // 12
        ImGui::PushStyleColor(ImGuiCol_TextSelectedBg, ImVec4(50 / 255.0f, 39 / 255.0f, 39 / 255.0f, 1.00f));    // 13
        ImGui::PushStyleColor(ImGuiCol_PlotHistogram, ImVec4(0.59f, 0.00f, 0.00f, 1.00f));                       // 14
    }
    else {
        ImGui::PushStyleVar(ImGuiStyleVar_FrameBorderSize, 1.0f * scale);
        ImGui::PushStyleVar(ImGuiStyleVar_WindowPadding, ImVec2(20.0f, 10.0f) * scale);
        ...
        ImGui::PushStyleColor(ImGuiCol_FrameBg, ImVec4(238 / 255.0f, 238 / 255.0f, 238 / 255.0f, 0.00f));        // 11
        ImGui::PushStyleColor(ImGuiCol_CheckMark, ImVec4(1.00f, 1.00f, 1.00f, 1.00f));                           // 12
        ImGui::PushStyleColor(ImGuiCol_TextSelectedBg, ImGuiWrapper::COL_RED_LIGHT);                           // 13
        ImGui::PushStyleColor(ImGuiCol_PlotHistogram, ImVec4(0.59f, 0.00f, 0.00f, 1.00f));                       // 14
    }
}
...
void ImGuiWrapper::push_confirm_button_style() {
    if (m_is_dark_mode) {
        ImGui::PushStyleColor(ImGuiCol_Button,        to_ImVec4(decode_color_to_float_array("#670000")));
        ImGui::PushStyleColor(ImGuiCol_Border, ImVec4(0.f / 255.f, 150.f / 255.f, 136.f / 255.f, 1.f));
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, to_ImVec4(decode_color_to_float_array("#8B0000")));
        ImGui::PushStyleColor(ImGuiCol_ButtonActive,  to_ImVec4(decode_color_to_float_array("#670000")));
        ...
        ImGui::PushStyleColor(ImGuiCol_Button,        to_ImVec4(decode_color_to_float_array("#960000")));
        ImGui::PushStyleColor(ImGuiCol_Border, ImVec4(0.f / 255.f, 150.f / 255.f, 136.f / 255.f, 1.f));
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, to_ImVec4(decode_color_to_float_array("#E53935")));
        ImGui::PushStyleColor(ImGuiCol_ButtonActive,  to_ImVec4(decode_color_to_float_array("#960000")));
...
void ImGuiWrapper::push_combo_style(const float scale)
{
    if (m_is_dark_mode) {
        ...
        ImGui::PushStyleVar(ImGuiStyleVar_FrameBorderSize, 1.0f * scale);
        ImGui::PushStyleColor(ImGuiCol_PopupBg, ImGuiWrapper::COL_WINDOW_BG_DARK);
        ImGui::PushStyleColor(ImGuiCol_BorderActive, ImVec4(0.f, 150.f / 255.f, 136.f / 255.f, 0.6f));  // MOMENT hovered item border color
        ImGui::PushStyleColor(ImGuiCol_HeaderHovered, {0.f, 0.f, 0.f, 0.f});                            // MOMENT hovered item background color
        ImGui::PushStyleColor(ImGuiCol_HeaderActive, COL_MOMENT);
        ImGui::PushStyleColor(ImGuiCol_Header, ImVec4(0.f, 150.f / 255.f, 136.f / 255.f, 0.25f));       // MOMENT active item background color
...
{
    ImGui::PushStyleVar(ImGuiStyleVar_FramePadding, ImVec2(1.5f, 1.5f) * scale); // MOMENT ensure icon size stays consistent
    if (m_is_dark_mode) {
        ImGui::PushStyleColor(ImGuiCol_CheckMark, to_ImVec4(decode_color_to_float_array("#960000"))); // MOMENT use orca color for radio buttons
        ImGui::PushStyleColor(ImGuiCol_Border   , to_ImVec4(decode_color_to_float_array("#949494"))); // MOMENT match border color
    } else {
        ImGui::PushStyleColor(ImGuiCol_CheckMark, to_ImVec4(decode_color_to_float_array("#960000"))); // MOMENT use orca color for radio buttons
        ImGui::PushStyleColor(ImGuiCol_Border   , to_ImVec4(decode_color_to_float_array("#7C8282"))); // MOMENT match border color
    }
}
...
void ImGuiWrapper::init_style()
{
    ...
    set_color(ImGuiCol_HeaderHovered,	to_ImVec4(to_rgba(ColorRGB::MOMENT(), 0.50f))); // MOMENT Use orca color for headers
    set_color(ImGuiCol_HeaderActive,	to_ImVec4(to_rgba(ColorRGB::MOMENT(), 0.75f)));  // MOMENT Use orca color for headers

    // Slider
    set_color(ImGuiCol_SliderGrab,			to_ImVec4(to_rgba(ColorRGB::MOMENT(), 0.50f))); // MOMENT Use orca color for slider thumbs 
    set_color(ImGuiCol_SliderGrabActive,	to_ImVec4(to_rgba(ColorRGB::MOMENT(), 0.75f))); // MOMENT Use orca color for slider thumbs 
