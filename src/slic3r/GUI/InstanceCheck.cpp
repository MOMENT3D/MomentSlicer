...
namespace MessageHandlerDBusInternal
{
	...
	static void respond_to_introspect(DBusConnection *connection, DBusMessage *request) 
	{
	    ...
	    const char  *introspection_data =
	        ...
	        "     </method>"
	        "   </interface>"
	        "   <interface name=\"com.momentslicer.MomentSlicer.InstanceCheck\">"
	...
	static DBusHandlerResult handle_dbus_object_message(DBusConnection *connection, DBusMessage *message, void *user_data)
	{
	    ...
	    std::string our_interface  = "com.momentslicer.MomentSlicer.InstanceCheck.Object" + wxGetApp().get_instance_hash_string();
...
void OtherInstanceMessageHandler::listen()
{
	...
	std::string			 interface_name = "com.momentslicer.MomentSlicer.InstanceCheck.Object" + instance_hash;
	std::string			 object_name 	= "/com/momentslicer/MomentSlicer/InstanceCheck/Object" + instance_hash;
