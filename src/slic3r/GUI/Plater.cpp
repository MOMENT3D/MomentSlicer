    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(42 * wxGetApp().em_unit(), -1)), p(new priv(parent))
{
    ...
    // add printer
    {
        ...
        bed_type_title->Bind(wxEVT_LEFT_UP, [bed_type_title, this](wxMouseEvent &e) {
            wxLaunchDefaultBrowser("https://github.com/SoftFever/MomentSlicer/wiki/bed-types");
        });
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(150, 0, 0), StateColor::Pressed),
                            std::pair<wxColour, int>(wxColour(150, 0, 0), StateColor::Hovered),
...
void Sidebar::sync_ams_list()
{
    ...
    if (unknowns > 0) {
        MessageDialog dlg(this,
            _L("There are some unknown filaments mapped to generic preset. Please update Moment Slicer or restart Moment Slicer to check if there is an update to system presets."),
            _L("Sync filaments with AMS"), wxOK);
        dlg.ShowModal();
    }
                ...
                Semver             file_version;
                {
                    ...
                    if (en_3mf_file_type == En3mfType::From_Prusa) {
                        ...
                        if(load_type != LoadType::LoadGeometry)
                            show_info(q, _L("The 3mf is not supported by MomentSlicer, load geometry data only."), _L("Load 3mf"));
                    }
                    ...
                    //             show_info(q, _L("The 3mf is generated by old Moment Slicer, load geometry data only."), _L("Load 3mf"));
                    //         else
                    //             show_info(q, _L("The 3mf is not supported by MomentSlicer, load geometry data only."), _L("Load 3mf"));
                    //     }
                ...
                wxCAPTION | wxCLOSE_BOX)
{
    ...
    m_confirm->SetBorderColor(wxColour(150, 0, 0));
