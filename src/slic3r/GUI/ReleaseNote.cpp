    ...
    :DPIFrame(parent, id, title, pos, size, style)
{
    ...
    auto sizer_button = new wxBoxSizer(wxHORIZONTAL);
    btn_bg_green = StateColor(std::pair<wxColour, int>(wxColour(103, 0, 0), StateColor::Pressed), std::pair<wxColour, int>(wxColour(182, 76, 76), StateColor::Hovered),
        std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
...
{
    m_button_ok->Enable();
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(182, 76, 76), StateColor::Pressed), std::pair<wxColour, int>(wxColour(182, 76, 76), StateColor::Hovered),
        std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
    m_button_ok->SetBackgroundColor(btn_bg_green);
    ...
    :DPIDialog(static_cast<wxWindow*>(wxGetApp().mainframe), wxID_ANY, _L("LAN Connection Failed (Sending print file)"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    comfirm_before_enter_text = _L("Step 1, please confirm Moment Slicer and your printer are in the same LAN.");
