...
static std::map<wxColour, wxColour> gDarkColors{
    {"#960000", "#670000"}, // rgb(0, 150, 136)    MOMENT color
    ...
    {"#E53935", "#8B0000"}, // rgb(0, 150, 136)    Button Confirm Color hover | MOMENT Color Hover
    ...
    {"#FAECEC", "#322727"}, // rgb(229, 240, 238)  Not Used anymore // Was used for BBS Combo / Dropdown focused background color
    ...
    {"#F0F0F1", "#333337"}, // rgb(240, 240, 241)  Disabled element background // MOMENT Used better background color for dark mode
