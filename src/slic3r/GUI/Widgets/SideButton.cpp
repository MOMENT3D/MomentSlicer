    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(103, 0, 0), StateColor::Pressed);
    border_color.append(wxColour(182, 76, 76), StateColor::Hovered);
    border_color.append(0x960000, StateColor::Normal);
    ...
    background_color.append(wxColour(103, 0, 0), StateColor::Pressed);
    background_color.append(wxColour(182, 76, 76), StateColor::Hovered);
    background_color.append(0x960000, StateColor::Normal);
