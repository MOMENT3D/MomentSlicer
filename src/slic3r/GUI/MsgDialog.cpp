...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) { 
        ...
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3mf file version is newer than the current Moment Slicer version."));
        wxStaticText *text2 = new wxStaticText(this, wxID_ANY, _L("Update your Moment Slicer could enable all functionality in the 3mf file."));
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
    }
...
wxBoxSizer *Newer3mfVersionDialog::get_btn_sizer()
{
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(103, 0, 0), StateColor::Pressed), std::pair<wxColour, int>(wxColour(182, 76, 76), StateColor::Hovered),
                            std::pair<wxColour, int>(wxColour(150, 0, 0), StateColor::Normal));
    StateColor btn_bg_white(std::pair<wxColour, int>(wxColour(206, 206, 206), StateColor::Pressed), std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Hovered),
                            std::pair<wxColour, int>(*wxWHITE, StateColor::Normal));
    bool       file_version_newer = (*m_file_version) > (*m_cloud_version);
