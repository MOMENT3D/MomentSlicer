    ...
    , m_machine("<null>")
{
    ...
    m_button_management->SetBackgroundColorNormal(wxColor("#960000"));
    m_button_management->SetTextColorNormal(*wxWHITE);
    m_button_management->Enable(false);
    m_button_refresh->SetBorderWidth(0);
    m_button_refresh->SetBackgroundColorNormal(wxColor("#960000"));
            ...
            if (index != -1) {
                ...
                fs->FetchModel(index, [this, fs, dlg, index](int result, std::string const &data) {
                    ...
                    if (gcode_file_count > 0) {
                        ...
                        MessageDialog dlg(this, _L("The .gcode.3mf file contains no G-code data.Please slice it with Moment Slicer and export a new .gcode.3mf file."), wxEmptyString, wxICON_WARNING | wxOK);
