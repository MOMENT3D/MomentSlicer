...
#define SLIC3R_APP_FULL_NAME "Moment Slicer"
#define GCODEVIEWER_APP_NAME "MomentSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "MomentSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("MomentSlicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
