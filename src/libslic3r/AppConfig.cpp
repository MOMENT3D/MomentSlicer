...
static const std::string VERSION_CHECK_URL_STABLE = "https://api.github.com/repos/moment3d/MomentSlicer/releases/latest";
static const std::string VERSION_CHECK_URL = "https://api.github.com/repos/moment3d/MomentSlicer/releases";
static const std::string PROFILE_UPDATE_URL = "https://api.github.com/repos/MomentSlicer/momentslicer-profiles/releases/tags";
