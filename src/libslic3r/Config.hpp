...
// When parsing a configuration value, if the old_value is not understood by this MomentSlicer version,
// it is being substituted with some default value that this MomentSlicer could work with.
