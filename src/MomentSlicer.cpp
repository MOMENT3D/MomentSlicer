...
std::map<int, std::string> cli_errors = {
    ...
    {CLI_GCODE_PATH_CONFLICTS, " G-code conflicts detected after slicing. Please make sure the 3mf file can be successfully sliced in the latest Moment Slicer."}
};
...
int CLI::run(int argc, char **argv)
{
    ...
    BOOST_LOG_TRIVIAL(warning) << boost::format("cli mode, Current MomentSlicer Version %1%")%SLIC3R_VERSION;
